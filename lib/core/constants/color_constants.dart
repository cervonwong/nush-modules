...
const Color kRoseColor400 = Color(0xfffb7185); // Also kErrorColor.
...
const Color kOrangeColor100 = Color(0xffffedd5);
const Color kOrangeColor200 = Color(0xfffed7aa);
const Color kOrangeColor300 = Color(0xfffdba74);
const Color kOrangeColor400 = Color(0xfffb923c); // Also kWarningColor.
const Color kOrangeColor500 = Color(0xfff97316);
const Color kOrangeColor600 = Color(0xffea580c);
...
const Color kRedColor400 = Color(0xfff87171);
